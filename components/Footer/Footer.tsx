...
export default function Footer() {
  return (
    <div className="bg-black text-white py-8 px-6">
      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <Image src="/Logo/Footer Logo.png" alt="Footer" height={20} width={20} />
              <h2 className="ml-2 text-xl font-bold">Sports World</h2>
            </div>
            <p className="text-sm text-gray-300">
              Founded in 2002, we focus on delivering the best sports driven products from world renowned brands to accelerate your performance and fitness growth.
            </p>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-gray-300">Orders & Payments</a></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-gray-300">Wish List</a></li>
      ...
      {/* Bottom Footer */}
      <div className="container mx-auto mt-8 pt-4 border-t border-gray-800">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-xs text-gray-400">©SportsWorld 2002. All rights reserved</p>
